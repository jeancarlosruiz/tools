...
function SchemeToggle({ initialTheme }: InitialThemeProps) {
  ...
  const handleThemeToggle = () => {
    ...
    const colors = nextTheme === "light" ? LIGHT_THEME : DARK_THEME;
